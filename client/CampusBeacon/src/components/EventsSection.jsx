...
const EventsSection = () => {
    ...
    const events = [
        ...
        },
        {
            ...
            date: "November ",
            description: "A night of music, dance and theatrical performances along with great innovation with tech",
            club: "Everyone",
            icon: "🎭",
        },
        {
    ...
    const clubs = ['ALL', 'Coding Club', 'Robotics Club', 'Cultural Club', 'Sports Club'];
